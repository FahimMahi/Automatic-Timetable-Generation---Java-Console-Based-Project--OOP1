...
public static void main(String[] args) {
  ...
  int action;
    ...
    else if (action==3)
    {
        ...
        teachers[0]=new TeacherDemo("Md. Nazmul Hossain","Java");
        teachers[1]=new TeacherDemo("Israt Kabir","Physics");
        teachers[2]=new TeacherDemo("Ayesha Siddiqua","Math");
        teachers[3]=new TeacherDemo("Rezwan Bin Mizan","Discrete Math");
        teachers[4]=new TeacherDemo("Md. Nazmul Hossain","Introduction to Programming");
